...
![](<그림_5.34_BD681 디지털 입력 커넥터 핀맵.JPG>)<br>
...
![](<그림_5.35_BD682 디지털 입력 커넥터 핀맵.JPG>)<br>
| 번호 | 신호명   | 신호 설명  |번호 | 신호명 | 신호 설명 |
|------|---------|---------- |-----|-------- |----------|
| 1    |COM_IN_A |COM 신호<br>(1~8)    | 11 | COM_IN_B | COM 신호<br>(9~16) |        
...
![](<그림_5.33_BD681 디지털 출력 커넥터 핀맵.JPG>)<br>
...
확장DIO보드(BD682) 추가 장착 시 핀맵 은 아래와 같습니다.<br>
![](<그림_5.36_BD682 디지털 출력 커넥터 핀맵.JPG>)<br>
| 번호 | 신호명   | 신호 설명  |번호 | 신호명 | 신호 설명 |
|------|---------|---------- |-----|-------- |----------|
...
![](<그림_5.37_BD682 컨베이어 커넥터 핀맵-1.JPG>)<br>
